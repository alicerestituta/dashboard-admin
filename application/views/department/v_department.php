                        ...
                        <div class="row">
                            <div class="col-md-8 col-12">
                                <div class="form-group">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-select" id="txdivision">
                                        </select>
                                    </fieldset>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="txcode" class="form-control" placeholder="Code" name="lname-column">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="last-name-column">Nama</label>
                                    <input type="text" id="txname" class="form-control" placeholder="Nama" name="lname-column">
                                </div>
                            </div>
